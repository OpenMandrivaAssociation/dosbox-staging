...
%{_bindir}/dosbox
%{_datadir}/applications/org.dosbox-staging.dosbox-staging.desktop
%dir %{_datadir}/dosbox-staging
%{_datadir}/icons/*/*/apps/org.dosbox-staging.dosbox-staging.*
%{_datadir}/metainfo/org.dosbox-staging.dosbox-staging.metainfo.xml
